...
namespace SistemaTren.MVC.Controllers
{
    ...
    public class RutasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("RutaID,Origen,Destino,Horario")] Ruta ruta)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("RutaID,Origen,Destino,Horario")] Ruta ruta)
        {
            if (id != ruta.RutaID)
            {
                return NotFound();
